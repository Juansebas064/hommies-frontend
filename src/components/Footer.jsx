...
const Footer = () => {
  return (
    ...
    <footer className="absoulte bottom-0 bg-gray-800 py-5 px-3 ">

      {/* Contenedor para limitar el ancho del contenido del footer */}
      <div className="flex justify-center min-[506px]:justify-between flex-wrap min-[824px]:flex-nowrap items-center text-left lg:text-left max-w-7xl mx-auto">
        ...
        <div className="flex items-center px-4 flex-shrink-0 text-center min-[506px]:text-left">
          ...
          <button
            className="bg-white text-lightBlue-600 px-0.5 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mx-2"
            type="button"
          >
        ...
        {/* Derechos de autor */}
        <div className="text-sm text-center w-full text-gray-100 font-semibold mx-5 flex-shrink order-last min-[824px]:order-[2] my-7 min-[824px]:my-0">
          Copyright © 2023. Proyecto creado por - Grupo 3 - Desarrollo de Software 1.
        </div>

        {/* Enlaces de interés */}
        <ul className="list-unstyled text-center min-[506px]:text-right flex-shrink-0 order-2 min-[824px]:order-[3] mt-7 min-[506px]:mt-0">
