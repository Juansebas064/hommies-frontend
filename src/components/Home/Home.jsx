    ...
    <div className="h-auto w-full bg-slate-100 px-6 py-3 ">
      <div className="flex flex-row items-center text-center space-y-5">
        ...
        >
          ...
          <div className="w-1/3 rounded-md px-6 bg-lime-50 ">
            <p className="sm:text-lg text-base font-semibold text-gray-900 mt-10 text-left">
            ...
            <p className="sm:text-2xl text-base font-semibold text-gray-900 mt-8 text-left">
              No te has unido aún? Crea una cuenta.
            </p>
            <a className="mx-8" href="/register">
              <svg
                role="img"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className="absolute mx-3 my-2 w-6 h-6 flex items-center justify-center"
              >
              ...
              <div className="bg-indigo-400 rounded-full w-1/3 h-10 flex items-center text-center justify-center hover:w-2/3 hover:h-12 hover:duration-100">
                Registrate
              </div>
            </a>
          </div>
