          ...
          <div className="w-1/3 rounded-md px-6 my-10 bg-lime-50 ">
            ...
            <a className="mx-8 w-1/3 flex items-center justify-center" href="/register">
              <svg
                ...
                className="absolute mx-3 my-2 w-6 h-6 sm:w-4 sm:h-4"
              >
              ...
              <div className="bg-indigo-400 pl-7 rounded-full w-1/3 h-10 flex items-center text-center sm:text-base text-xs justify-center hover:w-2/3 hover:h-12 hover:duration-100">
                Registrate
              </div>
            </a>
          </div>
