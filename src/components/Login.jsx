          ...
          <div className="md:flex w-full">
            <div className="w-full md:h-auto  py-10 px-5 md:px-10">
              <div className="text-center mb-10">
                <h1 className="font-bold text-3xl text-gray-900">Inicio sesión</h1>
              </div>
              <div>
                ...
                <div className="flex flex-col -mx-3">
                  <div className="w-full px-3 mb-3">
                    <div className="flex items-center justify-between">
                      ...
                      <a href="#" className="text-sm font-semibold text-indigo-500 hover:text-indigo-700">Recuperar contraseña</a>
                    </div>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button className="block w-full max-w-xs mx-auto mt-5 bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">
                      Continuar
                    </button>
